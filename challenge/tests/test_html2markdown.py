...
def test_urls():
    html = (
            'This is the <a href="https://pypi.org/project/html2markdown/">'
            'link</a> to the html2markdown package and '
            'here is <a href="https://github.com/dlon/html2markdown">'
            'another link</a> to the project homepage'
    )
    expected = (
            'This is the [link](https://pypi.org/project/html2markdown/)'
            ' to the html2markdown package and '
            'here is [another link](https://github.com/dlon/html2markdown)'
